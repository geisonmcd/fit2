...
export default function Diary({ navigation }) {
  ...
  const resources = [
    ...
    { name: 'Corrections', path: 'DiaryCorrections', icon: 'legal' },
    { name: 'Attendances', path: 'DiaryAttendances', icon: 'check-circle' },
    { name: 'Grades', path: 'DiaryGrades', icon: 'star' },
    { name: 'Incidents', path: 'DiaryIncidents', icon: 'address-book' },
    { name: 'Calendars', path: 'DiaryCalendars', icon: 'calendar' },
    { name: 'Free\nAssessments', path: 'DiaryFreeAssessments', icon: 'child' },
    { name: 'Exams', path: 'DiaryExams', icon: 'file-text' },
    { name: 'Notices', path: 'DiaryNotices', icon: 'bullhorn' },
    { name: 'Averages', path: 'DiaryAverages', icon: 'superscript' },
    { name: 'Reports', path: 'DiaryReports', icon: 'file-text' },
    { name: 'Students', path: 'DiaryStudents', icon: 'users' },
  ];
  ...
  return (
    <Page
      ...
      noDataIcon="check"
      noDataMessage="There are no items to show"
      columns={2}
